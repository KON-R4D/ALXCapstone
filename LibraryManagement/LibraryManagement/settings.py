...
SECRET_KEY = 'django-insecure-*1b72rhi_6&w)nlobhqo3-df442=v&cxjxp&k7k&36@)h-%g$f'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    # Add the newly created 'library' app
    'library',
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Require users to be authenticated by default
    ],
}
